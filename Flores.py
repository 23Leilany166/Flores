...
write("Las estraño", align="center", font=("Arial", 11, "normal")) # Cambia el fuente y tamaño del texto
# penup()
# goto(0, 330)
# pendown()
...
goto(0, -300)
pendown()
write("Para las niñas mas bonitas del univeros ", align="center", font=("Arial", 11, "normal"))
hideturtle()
